...
class RrvsForm(Form):
    ...
    str_irreg_dt_2_field = QuerySelectField(lazy_gettext("Second Structural Irregularity Detail"), query_factory=getStrIrreg2Dt, get_label=label, allow_blank=True)
    ...
    str_irreg_type_2_field = QuerySelectField(lazy_gettext("Second Structural Irregularity Type"), query_factory=getStrIrregType, get_label=label, allow_blank=True)
