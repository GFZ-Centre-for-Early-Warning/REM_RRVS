...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            #print('here dic',dic_attribute_val_py)
...
def update_rrvsform():
    ...
    return flask.jsonify(
		...
		dmg_gid = dic_attribute_val_py[dmg_val],
		...
		#vuln_gid = dic_attribute_value.query.filter_by(attribute_value=vuln_val).first().gid,
		#dmg_gid = dic_attribute_value.query.filter_by(attribute_value=dmg_val).first().gid,
		# query values for text fields
...
def rrvsform():
    ...
    if flask.request.method == 'POST' and rrvs_form.validate():
        ...
        row.update({ve_object.mat_type: rrvs_form.mat_type_field.data.attribute_value,
                    ...
                    ve_object.dmg: rrvs_form.dmg_field.data.attribute_value,
