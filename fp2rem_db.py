...
query="INSERT INTO asset.ve_object (survey_gid, source, the_geom, mat_type, mat_tech, mat_prop, llrs, llrs_duct, height, yr_built, occupy, occupy_dt, position, plan_shape, str_irreg, str_irreg_dt, str_irreg_type, nonstrcexw, roof_shape, roofcovmat, roofsysmat, roofsystyp, roof_conn, floor_mat, floor_type, floor_conn, foundn_sys, rrvs_status) SELECT survey.survey.gid, '{}', temporary_footprint_data.the_geom, 'MAT99', 'MATT99', 'SPO', 'L99', 'DU99', 'H', 'Y99', 'OC99', 'OCCDT99', 'BP99','PLF99','IR99', 'IRP99', 'IRT99','EW99','R99', 'RMT99', 'RSM99', 'RST99', 'RCN99', 'F99', 'FT99', 'FWC99', 'FOS99', 'UNMODIFIED' FROM temporary_footprint_data,survey.survey WHERE survey.survey.name='{}';".format(source,survey_name)
